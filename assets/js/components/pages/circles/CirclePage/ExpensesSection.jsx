...
class ExpensesSection extends React.PureComponent {
  constructor(props) {
    super(props);
  }

  render() {
    const expenses = this.props.budget.fields
          ...
          <TableBody>
            {expenses.map(e => (
              <TableRow>
                ...
                <TableCell className='ExpensesSection__table__completed'>{e.is_completed ? <CheckMark /> : null}</TableCell>
